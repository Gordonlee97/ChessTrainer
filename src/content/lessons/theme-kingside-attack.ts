  ...
  segments: [
    {
      ...
      intro:
        'This is the position from the Italian Game lesson — you\'ve already been here. Now the plan: walk the knight on b1 — still sitting on its own starting square, on the queenside, the half of the board behind your queen — all the way to d2, then f1, then g3, over to the kingside, the half both kings castled to. The queenside is quiet and has nothing left for the knight to do, so it heads instead toward more space — more squares your pieces control — where Black\'s king lives. One more term: files are the board\'s vertical columns, and a rook wants to stand on one with no pawns in the way.',
      moves: [
